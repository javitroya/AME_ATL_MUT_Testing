...
public class CopyOfTransfoRunnerEMFTVM {
...
//		outModel.setResource(rs.createResource(URI.createFileURI("tmp/PetriNet2PNML-out.xmi")));
...
//		Metamodel mm1 = EmftvmFactory.eINSTANCE.createMetamodel();
//		mm1.setResource(rs.getResource(URI.createURI("http://www.eclipse.org/gmt/2005/ATL"), true));
//		env.registerMetaModel(srcMMname1, mm1);
//		
...
//		env.registerMetaModel(srcMMname1, mm2);
//		
...
//		env.registerOutputModel("IN_MM", inModel1);
//		
...
//		env.registerOutputModel("OUT_MM", inModel2);
//
//		// Load and run module
//		ModuleResolver mr = new DefaultModuleResolver(modulePath, rs);
//		TimingData td = new TimingData();
